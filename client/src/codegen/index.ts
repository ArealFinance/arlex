 ...
 * and returns the source for `accounts.generated.ts`, `instructions.generated.ts`,
 * and `errors.generated.ts` as strings. No file-system writes happen here —
 * that responsibility lives in the CLI / writer layer so the module is
 * easy to embed in build tooling and tests.
 */
...
export interface GeneratedSources {
  ...
  filenames: { accounts: string; instructions: string; errors: string };
}

/**
 * Generate TS source strings for all three output files.
 *
